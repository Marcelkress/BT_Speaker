...
A speaker like this could be built using a simple bluetooth amplifier board, but you don't get access to play/pause commands and LED indicators in the same way. Additionally, fast forward / prev track, is also possible using the bluetooth library.
